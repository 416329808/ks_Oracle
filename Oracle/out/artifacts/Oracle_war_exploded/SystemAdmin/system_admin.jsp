		 ...
		 <div class="col-md-12">
			...
			<div class="tab-content">
			    ...
			    <div id="menu2" class="tab-pane fade">	
			        <iframe src="teacher_admin.jsp" frameborder="0" style="width: 100%;height: 520px;" ></iframe>		      
			    </div>
			    <div id="menu3" class="tab-pane fade">	
			        <iframe src="student_admin.jsp" frameborder="0" style="width: 100%;height: 520px;" ></iframe>		      
			    </div>
			</div>
	     </div>
	  </div>	  
