...
$(document).ready(function(){ 
	$("#cancel").click(function(){	
		location.href="/Oracle/QueryAllTeacherServlet";
		});});
		
$(document).ready(function(){ 
	$("#sure").click(function(){	
		location.href="../AddTeacherServlet?TeacherID="+$("#TeacherID").val()+
				"&TeacherName="+$("#TeacherName").val()+"&Sex="+$("#Sex").find("option:selected").text()+
				"&BelongsInstituteName="+$("#instituteName").find("option:selected").text();
		});});		
   ...
   <div class="container">
     ...
     <table class="table table-bordered">
		  ...
		  <tbody>
		    <tr>
		      <td>
		          <input type="text" class="form-control" style="width: 100%;text-align: center;" id="TeacherID">
		      </td>
		      <td>
		         <input type="text" class="form-control" style="width: 100%;text-align: center;" id="TeacherName">
		      </td>
		      <td>
