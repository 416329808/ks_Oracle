...
$(document).ready(function(){ 
	$("#cancel").click(function(){	
		location.href="QueryAllStudentServlet";
		});});
		
$(document).ready(function(){ 
	$("#sure").click(function(){	
		location.href="/Oracle/UpdateStudentServlet?StudentID="+$("#studentID").val()+
    ...
    <div class="container">    
     ...
     <table class="table table-bordered">
		  ...
		  <tbody>
		    <tr>
		      <td>
		          <input type="text" class="form-control" style="width: 100%" value="<%=stu.getStudentID()%>" id="studentID" readonly="readonly">
		      </td>
		      <td>
		         <input type="text" class="form-control" style="width: 100%" value="<%=stu.getStudentName()%>"  id="studentName">
		      </td>
		      <td>
