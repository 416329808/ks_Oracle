		 ...
		 <div class="col-md-12">
			...
			<div class="tab-content">
			    <div id="home" class="tab-pane fade in active">
			       <iframe src="/Oracle/StudentInfoServlet?ID=<%=BusinessPersonID %>" frameborder="0" style="width: 100%;height: 100%;" scrolling="no"></iframe>
			    </div>
			    ...
			    <div id="menu2" class="tab-pane fade">	
			        <iframe src="AffairAdmin/course_admin.jsp" frameborder="0" style="width: 100%;height: 520px;" ></iframe>		      
			    </div>
			    <div id="menu3" class="tab-pane fade">	
			        <iframe src="/Oracle/ChapterinfoServlet" frameborder="0" style="width: 100%;height: 520px;" ></iframe>		      
			    </div>
			    <div id="menu4" class="tab-pane fade">	
			        <iframe src="AffairAdmin/question_type_admin.jsp" frameborder="0" style="width: 100%;height: 520px;" ></iframe>		      
			    </div>
