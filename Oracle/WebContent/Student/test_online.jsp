...
<body>
	<%
		...
		String paperNum= (String) request.getAttribute("paperNum");
	...
	<div class="container">
		...
		<div class="form-group">
			<label for="no" class="col-md-2 control-label">试卷编号:</label>
			<div class="col-md-8">
				<input type="text" class="form-control" id="no"
					style="border-style: none" value=<%=paperNum%> readonly>
			</div>
		</div>
					...
					<td>
						<div class="form-group col-md-11">
							...
							<div class="col-sm-11"><%= question1.getTopics()%>
								<br>
								A.<%=question1.getOptionA() %>
								<br>
								B.<%=question1.getOptionB() %>
								<br>
								C.<%=question1.getOptionC() %>
								<br>
								D.<%=question1.getOptionD() %>
							</div>
						</div> <!-- 填入的答案 -->
						<div class="col-md-1">
